...
const Home = () => {
  ...
  {/* <div className="mask" style="background-color: rgba(57, 192, 237, 0.2)"></div> */}
  {/* </a> */}
  {/* </div> */}
...
<div className="cover-content d-flex flex-column justify-content-center align-items-center">
                    <img className="rounded-circle" alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTr9LRH7H3MbqP0bckvppQq_VD5yl3Qq7h75g&usqp=CAU"/>
                    <h1 className="display-2 text-capitalize">Welcome</h1>
                    <h6 className="pt-3 h4">FullStack Developer - Web Designer - UI/UX</h6>
                </div>
            </div>
